        ...
        <div className='px-4'>
            ...
            <div style={{ fontFamily: "Franklin" }} className="w-full md:w-3/4 mx-auto p-8 bg-white rounded-lg space-y-6 shadow-lg ">
                ...
                <div className="lg:ml-48">
                    ...
                    <p>Annual Conference Price: S$175++ per night (Only for AC 2025 - Registerd Members, Please contact us for Registration Number before booking hotel accommodation)</p>
