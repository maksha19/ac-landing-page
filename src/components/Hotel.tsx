        ...
        <div className='px-4'>
            ...
            <div style={{ fontFamily: "Franklin" }} className="w-full md:w-3/4 mx-auto p-8 bg-white rounded-lg space-y-6 shadow-lg ">
                <div className="lg:ml-48">
                    ...
                    <p> <span className="underline mr-2">Annual Conference Price:</span> S$300++ per night (Registered Members - Please contact us to avail Registration Number before booking hotel accommodation)</p>
                ...
                <div className="lg:ml-48">
                    ...
                    <p> <span className="underline mr-2">Annual Conference Price:</span>  S$175++ per night (Registered Members - Please contact us to avail Registration Number before booking hotel accommodation)</p>
