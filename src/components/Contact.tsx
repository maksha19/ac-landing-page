...
const Contact = () => {
    ...
    return (
        <div className="max-w-md mx-auto p-8 bg-white rounded-lg shadow-lg">
            ...
            <p className="md:text-lg mb-4"><span className="inline-block">Email</span> : <a href="mailto:pqdd80@gmail.com" className="text-blue-500  hover:underline"> pqdd80@gmail.com</a></p>
